import { popUpPreview, openPopUp, } from "./utils.js";
...
export default class Card {
  constructor(data, templateSelector) {
      ...
      this._elementTemplate= this._templateSelector
        .content
  ...
  createCardElement() {
    ...
    //opne preview
    this._element.querySelector(".elements__cover").addEventListener("click", () => {
